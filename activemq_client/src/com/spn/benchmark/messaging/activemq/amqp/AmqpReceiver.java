package com.spn.benchmark.messaging.activemq.amqp;
...
public class AmqpReceiver {
	...
	private final static String QUEUE_NAME = "activeMQ_QPID_AMQP";
	private final static int TIMEOUT = 1000000000;

	public static void main(String args[]) {
		JmsConnectionFactory factory = new JmsConnectionFactory("user", "user", "amqp://localhost");
